    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
          ...
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-foreground">Revenue Reports</h1>
            <p className="text-xs sm:text-sm text-muted-foreground">Analyze revenue trends and performance metrics</p>
          </div>
        </div>
